        ...
        if (in_array($house_image_actual_ext, $allowed)) {
            if ($house_image_error === 0) {
                if ($house_image_size < 1000000) {
                    ...
                    $sql = "INSERT INTO `houses` (`house_name`, `house_address`, `house_postcode`, `house_city`, `house_state_id`, `house_type`, `house_description`, `house_image`) VALUES ('$house_name', '$house_address', '$house_postcode', '$house_city', '$house_state', '$house_type', '$house_description', '$house_image_new_name')";
                    $result = mysqli_query($conn, $sql);

                    if ($result) {
                        set_flash_mesage('House added successfully.', 'success');
                    } else {
                        set_flash_mesage('Failed to add house.', 'danger');
                    }
                    redirect('house.php');
                } else {
                        ...
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control <?= isset($errors['house_name']) ? 'is-invalid' : '' ?>" id="house_name" name="house_name" placeholder="House Name" value="<?= isset($house_name) ? $house_name : '' ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select class="form-control <?= isset($errors['house_type']) ? 'is-invalid' : '' ?>" id="house_type" name="house_type">
                                                    ...
                                                    <option value="apartment" <?= isset($house_type) && $house_type == 'apartment' ? 'selected' : '' ?>>Apartment</option>
                                                    <option value="condominium" <?= isset($house_type) && $house_type == 'condominium' ? 'selected' : '' ?>>Condominium</option>
                                                    <option value="terrace" <?= isset($house_type) && $house_type == 'terrace' ? 'selected' : '' ?>>Terrace</option>
                                                    <option value="bungalow" <?= isset($house_type) && $house_type == 'bungalow' ? 'selected' : '' ?>>Bungalow</option>
                                                    <option value="semi-detached" <?= isset($house_type) && $house_type == 'semi-detached' ? 'selected' : '' ?>>Semi-Detached</option>
                                                    <option value="detached" <?= isset($house_type) && $house_type == 'detached' ? 'selected' : '' ?>>Detached</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control <?= isset($errors['house_address']) ? 'is-invalid' : '' ?>" id="house_address" name="house_address" rows="3" placeholder="House Address"><?= isset($house_address) ? $house_address : '' ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?= isset($errors['house_city']) ? 'is-invalid' : '' ?>" id="house_city" name="house_city" placeholder="House City" value="<?= isset($house_city) ? $house_city : '' ?>">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control <?= isset($errors['house_postcode']) ? 'is-invalid' : '' ?>" id="house_postcode" name="house_postcode" placeholder="House Postcode" value="<?= isset($house_postcode) ? $house_postcode : '' ?>">
                                            ...
                                            <div class="col-sm-4">
                                                <select class="form-control <?= isset($errors['house_state']) ? 'is-invalid' : '' ?>" id="house_state" name="house_state">
                                                    ...
                                                    <?php while ($row_states = mysqli_fetch_assoc($result_states)) : ?>
                                                        <option value="<?= $row_states['state_id'] ?>" <?= isset($house_state) && $house_state == $row_states['state_id'] ? 'selected' : '' ?>><?= $row_states['state_name'] ?></option>
                                                    <?php endwhile ?>
                                                </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <textarea class="form-control <?= isset($errors['house_description']) ? 'is-invalid' : '' ?>" id="house_description" name="house_description" rows="3" placeholder="House Description"><?= isset($house_description) ? $house_description : '' ?></textarea>
